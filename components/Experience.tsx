...
export const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-24 w-full max-w-4xl px-6 mx-auto">
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-12 sm:gap-8 items-start mb-16">
              ...
              <div className="space-y-4">
                <ul className="space-y-3">
                  {exp.highlights.map((item, i) => (
                    <li
                      key={i}
                      className="flex gap-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed group/item"
                    >
                      ...
                      <span
                        dangerouslySetInnerHTML={{
                          __html: item
                            .replace(
                              "7.12 minutes",
                              "<span class='text-zinc-900 dark:text-zinc-200 font-semibold'>7.12 minutes</span>"
                            )
                            .replace(
                              "52.7%",
                              "<span class='text-zinc-900 dark:text-zinc-200 font-semibold'>52.7%</span>"
                            ),
                        }}
                      />
                    </li>
