        ...
        >
          ...
          <Link to="home" smooth={true} className="cursor-pointer">
            <div className="text-lg font-bold tracking-tighter text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
              <span className="w-6 h-6 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 flex items-center justify-center rounded-md text-xs font-mono">S</span>
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              <Link
                ...
                spy={true}
                offset={-100}
                className="px-4 py-1.5 text-sm font-medium text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 cursor-pointer transition-colors rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800/50"
                activeClass="!text-zinc-900 dark:!text-zinc-100 bg-zinc-100 dark:bg-zinc-800"
              >
                {item}
              </Link>
            ))}
